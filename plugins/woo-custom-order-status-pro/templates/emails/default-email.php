...
<p>
	<?php printf( __( 'You have received an order from %s. Their order is as follows:', 'woocommerce' ), 
				$order->billing_first_name . ' ' . $order->billing_last_name ); ?>
</p>
<?php if( isset($ops['woocommerce_woo_advance_order_status_email_order_info']) 
			&& (int)$ops['woocommerce_woo_advance_order_status_email_order_info'] == 1 ): ?>
...
<p>
	<b><?php _e('Payment Method:', 'AppZab_woo_advance_order_status'); ?></b><?php print get_post_meta( $order->id, '_payment_method_title', 1); ?>
</p>
<?php endif; ?>
...
<p>
	<b><?php _e('Shipping Method:', 'AppZab_woo_advance_order_status'); ?></b><?php print $order->get_shipping_method(); ?>
</p>
<?php endif; ?>
...
<div><?php print $ops['woocommerce_woo_advance_order_status_email_custom_msg']; ?></div>
<?php endif; ?>
