    ...
    class YITH_WCAN_Admin_Premium extends YITH_WCAN_Admin {
        ...
        public function panel_frontend_options( $options ){
            ...
            $options['frontend']['settings'][] = array(
                'name'    => _x( 'Enable Scroll Top', '[Admin] Option name', 'yith-woocommerce-ajax-navigation' ),
                'desc'    => __( 'Select whether you want to enable the "Scroll to top" option on Desktop, Mobile, or on both of them', 'yith-woocommerce-ajax-navigation' ),
