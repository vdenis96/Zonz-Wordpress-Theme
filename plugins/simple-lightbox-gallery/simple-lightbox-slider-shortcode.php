    ...
    <div class="gal-container" id="slgf_<?php echo esc_attr($SLGF_Id); ?>">
		<?php while ( $loop->have_posts() ) : $loop->the_post(); ?>
			...
			<?php if ( $SLGF_Show_Gallery_Title == "yes" ) { ?>
                <div style="font-weight: bolder; padding-bottom:20px; border-bottom:2px solid #cccccc;margin-bottom: 20px;font-family: <?php echo esc_attr($SLGF_Font_Style); ?>">
                            ...
                            <div class="img-box-shadow">
								...
								<?php if ( $SLGF_Show_Image_Label == "yes" && $name ) { ?>
                                    <div class="slgf_home_portfolio_caption">
                                        <h3 class="b-wrapper"><?php echo esc_html($name); ?></h3>
