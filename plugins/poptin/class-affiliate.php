...
class Poptin_affiliate_program {
    ...
    public function admin_notices() {
        if(current_user_can('manage_options')) {
            ...
            <div class="notice admin-poptin-box notice-info <?php echo $this->plugin_slug ?>-premio-affiliate <?php echo $this->plugin_slug ?>-premio-affiliate">
                ...
                <a class="button button-primary <?php echo $this->plugin_slug ?>-affiliate-btn" target="_blank" href="https://www.poptin.com/affiliate/?utm_source=wordpressplugin&domain=<?php echo $_SERVER['HTTP_HOST'] ?>">Tell me more <span class="dashicons dashicons-arrow-right-alt"></span></a>
            </div>
