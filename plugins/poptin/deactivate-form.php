    ...
    <div class="poptin-serveypanel">
        ...
        <form action="#" method="post" id="poptin-deactivate-form">
            <div class="poptin-popup-header">
                <h2><?php esc_attr_e('Quick feedback about Poptin', 'poptin'); ?> 🙏</h2>
            </div>
            <div class="poptin-popup-body">
                <h3><?php esc_attr_e('Your feedback will help us improve the product, please tell us why did you decide to deactivate Poptin :)', 'poptin'); ?></h3>
                ...
                <div class="form-control">
                    <label></label>
                    <textarea placeholder="<?php esc_attr_e("Your comment", 'poptin') ?>" id="poptin-deactivation-comment"></textarea>
                </div>
            </div>
            <div class="poptin-popup-footer">
                <label class="poptin-anonymous">
                    <input type="checkbox"/><?php esc_attr_e('Anonymous feedback', 'poptin'); ?>
                </label>
                ...
                <div class="action-btns">
                    ...
                    <a href="#" class="button button-primary poptin-popup-button-close"><?php esc_attr_e('Cancel', 'poptin'); ?></a>
                </div>
            </div>
        </form>
        <!-- form end -->
            ...
            $(document).on('submit', '#poptin-deactivate-form', function (event) {
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        reason: _reason,
                        email_id: email_id,
                        nonce: '<?php esc_attr_e(wp_create_nonce("poptin_deactivate_nonce")) ?>'
                    },
                    beforeSend: function () {
                        $(".poptin-spinner").show();
