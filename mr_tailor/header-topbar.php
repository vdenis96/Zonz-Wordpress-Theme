<div id="site-top-bar msg">
    ...
    <div class="row">
        ...
        <div class="large-5 columns">
            ...
            <div class="site-top-message test"><?php if ( isset($mr_tailor_theme_options['top_bar_text']) ) _e( $mr_tailor_theme_options['top_bar_text'], 'mr_tailor' ); ?></div> 
