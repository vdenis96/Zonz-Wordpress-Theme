<?php
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array (
            ...
            array (
                'title' => __('Add to Cart Button', 'mr_tailor_settings'),
                'subtitle' => __('<em>Display the button on hover or display it all the time.</em>', 'mr_tailor_settings'),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array (
            ...
            array (
                'title' => __('Portfolio Posts Slug', 'mr_tailor_settings'),
                'subtitle' => __('<em>Enter a custom slug for portfolio item posts.</em>', 'mr_tailor_settings'),
                'desc'  => __('<em>Default slug is "portfolio-item". Enter a custom one to overwrite it. <br/><b>You need to regenerate your permalinks if you modify this!</b>', 'mr_tailor_settings'),
