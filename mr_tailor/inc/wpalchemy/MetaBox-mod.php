...
//local modification oleg 15052020 - fixing count(): Parameter must be an array or an object...
		//$cnt = count(!empty($this->meta[$n])?$this->meta[$n]:NULL);
////error_log('222 $this->meta[$n]');
//// error_log(print_r($this->meta[$n],true)); // this gives error in log Illegal string offset 'items'
$cnt = 0;	
//end of local modification oleg 15052020

if (!empty($this->meta[$n])) {
		$cnt = count($this->meta[$n]);	
	}
