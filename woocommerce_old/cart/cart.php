				...
				<tr class="<?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
					...
					<td class="product-name" data-title="<?php _e( 'Product', 'woocommerce' ); ?>">
						<?php
                            ...
                            ?>
                            <div class="attributes" style="<?php echo ($attr[$cart_item_key]['area']) ? '' : 'display:none' ?>">
                                <?php if ($attr[$cart_item_key]['area']) { ?>
                                <style>
                                .woo_quote_button {display: inline-block !important;}
                                </style>
                                <?php } ?>
                                                    <div class="attr"><strong>Oppervlakte:&nbsp;</strong><?=$attr[$cart_item_key]['area'];?></div>
                                                    <!--
