...
function mr_tailor_entry_meta() {
	...
	if ( 'post' == get_post_type() ) {
		printf( __( ' Dit bericht werd geplaatst door ', 'mr_tailor' ) . '<a class="url fn n" href="%1$s" title="%2$s" rel="author">%3$s</a>',
	...
	if ( $categories_list ) {
		echo __( ' in de categorie ', 'mr_tailor' ) . $categories_list . '';
	}
