				...
				<?php if ( is_single() ) : // navigation links for single posts ?>
                    ...
                    <div class="row">
                        ...
                        <div class="large-6 columns text-center">
                            <div class="nav-previous"><?php previous_post_link( '%link', '<div class="nav-previous-title">'.__( "Voorgaand bericht", "mr_tailor" ).'</div> &larr; %title' ); ?></div>
                        </div><!-- .columns -->
                        
                        <div class="large-6 columns text-center">
                            <div class="nav-next"><?php next_post_link( '%link', '<div class="nav-next-title">'.__( "Volgend bericht", "mr_tailor" ).'</div> %title &rarr;' ); ?></div>
                        </div><!-- .columns -->
