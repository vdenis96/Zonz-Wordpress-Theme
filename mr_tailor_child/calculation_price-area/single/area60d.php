...
/*
        ...
        function area() {
            ...
            if (ca = jQ('#pa_bevestigingsmateriaal-test option:selected').attr('data-size')) {
                ca = jQ('#pa_bevestigingsmateriaal-test option:selected').attr('data-size');
            } else {
                ca = 0;
            }
            if (cb = jQ('#pa_bevestigingsmateriaal-test2 option:selected').attr('data-size')) {
                cb = jQ('#pa_bevestigingsmateriaal-test2 option:selected').attr('data-size');
            } else {
                cb = 0;
            }
            if (cc = jQ('#pa_bevestigingsmateriaal-test3 option:selected').attr('data-size')) {
                cc = jQ('#pa_bevestigingsmateriaal-test3 option:selected').attr('data-size');
            } else {
                cc = 0;
            }
...
<?php } ?>
        ...
        function trian90d () {
            ...
            var yy = Math.sqrt(((jQ("#h").attr('digit') * 100)*(jQ("#h").attr('digit') * 100))-((jQ("#h").attr('digit') * 50)*(jQ("#h").attr('digit') * 50)));
            circles[1] = {x: (jQ("#h").attr('digit') * 50 ), y: ((jQ("#h").attr('digit') * 100 )-yy), r: rad};
            circles[2] = {x: (jQ("#h").attr('digit') * 100), y: (jQ("#h").attr('digit') * 100 ), r: rad};
