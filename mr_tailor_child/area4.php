...
<!--                <script src="https://raw.githubusercontent.com/caleb531/jcanvas/master/jcanvas.js"></script>-->
    ...
    <div id="test" style="display: none;">area4.php</div>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="tabl sizes ds-none">
        ...
        <div class="tab-row canvas_block">
            <div class="tab-cel"></div>
            <div class="tab-cel">
                <input type="button" value="Oeps ik heb een foutje gemaakt en wil mijn ZONZ sunsail opnieuw intekenen!" onclick="rax();"/>
            </div>
        </div>
        <div class="tab-row siz">
            <div class="tab-cel">
            </div>
            <div class="tab-cel">
                <?php 
        ...
        <div class="inform">
            ...
            <button class="single_add_to_cart_button button2 alt" type="button" title="Stel allereerst jouw product samen alvorens je deze in jouw winkelmandje legt.">
                Voeg mijn ZONZ maatwerk toe aan mijn winkelmandje
            </button>
        </div>
    </div>
    ...
    <script>
        ...
        function holes_count() {
            ...
            if (!areaoff) {
                ...
                sides(1); 
                console.log('sides');
                jQ('.tabl').removeClass("ds-none");
                jQ('.after_input').addClass("ds-none");
            }
        }
