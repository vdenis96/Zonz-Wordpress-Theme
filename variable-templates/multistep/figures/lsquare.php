<div class="entry-content triangle" style="width: 400px; margin: 0 auto; display: block;">
            ...
            <table class="variations-table2222 var-tab" cellspacing="0">
                ...
                <tr class="tr-waterdoorlatend">
                    <td colspan="2">Vul de afstand tussen je pergolabalken of muren in. De maximale doekgrootte is 17,5 m2.</td>
                </tr>
                <tr class="tr-waterdoorlatend">
                ...
                <td colspan="2">
                        ...
                        <script>
                            ...
                            /*let first_step_val = jQuery('#first_step_choose_input').val();
                            let table_elem_1 = document.getElementById('variation_first_step_waterdoorlatend');
                            let table_elem_2 = document.getElementById('variation_first_step_waterdicht');
