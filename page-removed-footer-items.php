<?php
/*
Template Name: Page with removed items in the footer
*/
?>
        ...
        <div id="content" class="site-content" role="main">
            ...
            <?php endwhile; // end of the loop. ?>
                    ...
                    <footer id="site-footer" role="contentinfo">
                        ...
                        <?php endif; ?>
                        <div class="my-site-footer-area text-center"><img src="/wp-content/themes/mrtailor-child/img/Betaalmethodes-ZONZ-sunsail-Webshop_cef878c1099801892edaf48e73c4ae23.png" alt="Betaalmethodes ZONZ sunsail Webshop"/></div>                     
