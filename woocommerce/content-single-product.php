...
//oleg
  error_log(print_r('oleg 1111',true)); 
...
//// oleg15062020
	...
	if(get_field('contact_form_button') !== NULL && get_field('contact_form_button')) {
		remove_action( 'woocommerce_single_product_summary', 'woocommerce_template_single_add_to_cart', 30 );
		
		add_action( 'woocommerce_single_product_summary', 'button_contact', 30 );
		function button_contact() {
			?>
			<a href="#product_form_popup" class="open-popup-link create_request_button button alt">Create request</a>
			<?php
		}

		add_action('wp_footer', 'add_contact_form_popup');
		function add_contact_form_popup() {
			?>
			<div id="product_form_popup" class="white-popup mfp-hide">
				<?php echo do_shortcode('[contact-form-7 id="1525774" title="Request for payment" product_name="' . get_the_title() . '"]'); ?>
			</div>
			<?php
		}
...
//oleg
  error_log(print_r('oleg 222222',true)); 
...
<?php //oleg
  error_log(print_r('oleg 33333',true)); ?>
...
<?php //oleg
  error_log(print_r('oleg 444444',true)); ?>
...
<?php //oleg
  error_log(print_r('oleg 4444_1',true)); ?>

					  
	<div class="single-product">				  
        <div class="row" data-sticky_parent="">				  
			<div class="image-block large-6 columns">		 
				<div data-sticky_column="" class="large-5 large-push-0 medium-8 medium-push-2 row sticky">
					...
					<?php				
						...
						//!!!oleg
						  error_log(print_r('oleg 4444_1_1_1: woocommerce_before_single_product_summary_product_images  takes 20 sec ',true));
						  
											do_action( 'woocommerce_before_single_product_summary_product_images' );

						//oleg
						  error_log(print_r('oleg 4444_1_1_2',true));
						  
											do_action( 'woocommerce_before_single_product_summary' );
										?>
										
						<?php //oleg
						  error_log(print_r('oleg 4444_1_1',true)); ?>
				...
				<!--<div data-sticky_column="" class="large-1 row product_summary_thumbnails_wrapper without_sidebar">
					<div><?php// do_action( 'woocommerce_product_summary_thumbnails' ); ?>&nbsp;</div>
				</div>--><!-- .columns -->
...
<?php //oleg
  error_log(print_r('oleg 4444_1_2',true)); ?>
			...
			<?php endif; ?>
				...
				<div class="product_infos">
<?php //oleg
  error_log(print_r('oleg 4444_1_3',true)); ?>
					
					<?php
						do_action( 'woocommerce_single_product_summary_single_price' );
						//do_action( 'woocommerce_single_product_summary_single_excerpt' );
echo '<!-- oleg1111_content-single-product.php -->';
 //oleg
  error_log(print_r('oleg 4444_1_3_1',true));
 ...
 <?php //oleg
  error_log(print_r('oleg 4444_1_4',true)); ?>           
...
<?php //oleg
  error_log(print_r('oleg 4444_2',true)); ?>
...
<?php //oleg
  error_log(print_r('oleg 4444_3',true)); ?>
...
<?php //oleg
  error_log(print_r('oleg 4444_4',true)); ?>
...
//oleg
  error_log(print_r('oleg 55555',true));
                ...
                ?>
        <div class="row">
			<div class="large-10 large-centered columns large-content-page">        
                <?php 
...
<?php //oleg
  error_log(print_r('oleg 77777',true)); ?>
                <?php 
...
<?php //oleg
  error_log(print_r('oleg 99999',true)); ?>
