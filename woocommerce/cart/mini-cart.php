					...
					<tr>
                        ...
                        <td class="product-name">                        
                            ...
                            <?php echo WC()->cart->get_item_data( $cart_item ); ?>
                             <?php if( $attr =  $_SESSION['productAttr'][$product_id]): ?>
                                        <dl class="variation">
                                            <dt>Mystyle: </dt>
                                            <dd><?=$attr['mystyle']?></dd>
                                            <dt>Area: </dt>
...
<?php if ( ! WC()->cart->is_empty() ) : ?>
	...
	<p class="total"><strong class="subtotal_name"><?php _e( 'Subtotaal', 'woocommerce' ); ?>:</strong> <?php echo WC()->cart->get_cart_subtotal(); ?></p>

	<?php do_action( 'woocommerce_widget_shopping_cart_before_buttons' ); ?>

	<p class="buttons">
		<a href="<?php echo esc_url( wc_get_cart_url() ); ?>" class="button view_cart wc-forward"><?php _e( 'Winkelmand bekijken', 'woocommerce' ); ?></a>
		<a href="<?php echo esc_url( wc_get_checkout_url() ); ?>" class="button checkout wc-forward"><?php _e( 'Afrekenen', 'woocommerce' ); ?></a>
	</p>
