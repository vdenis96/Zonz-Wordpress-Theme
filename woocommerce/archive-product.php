...
?>
	<div id="primary" class="content-area catalog-page <?php echo $shop_page_has_sidebar ? 'with-sidebar' : 'without-sidebar'; ?>">
        ...
        <div class="category_header <?php if ($category_header_src != "") : ?>with_featured_img<?php endif; ?>" <?php if ($category_header_src != "") : ?>style="background-image:url(<?php echo $category_header_src ; ?>)<?php endif; ?>">
            ...
            <div class="row">
                <div class="large-8 large-centered columns cat1-title">
                        ...
                        <?php if (!is_paged()) : //show categories only on first page ?>
							...
							<?php if ($show_categories == TRUE) : ?>
                                ...
                                <div class="row">
                                    ...
                                    <?php 
                                        //$termids = array('25','633');
                                        //if(in_array($term->term_id, $termids)): 
                                        if($term->term_id == 25):
                                    ?>
                                            <h2 style="text-align: center; color: #009DDC;">Klik op een van onderstaande vormen om snel jouw prijs van een maatwerk schaduwdoek met gecurvde zijden te zien.</h2>
                                    <?php 
                                        endif; 
                                        if($term->term_id == 633):
                                    ?>
                                            <h2 style="text-align: center; color: #009DDC;">Klik op een van onderstaande vormen om snel jouw prijs van een maatwerk schaduwdoek met rechte zijden te zien.</h2>
                                    <?php 
                                        endif; 
                                    ?>

                                    <div class="categories_grid" style="margin-bottom: 10px;">
                                    ...
                                    <h2 style="text-align: center"><a href="/keuzehulp-schaduwdoeken-zonz-sunsails/" title="Keuzehulp Schaduwdoeken">Hulp nodig bij jouw perfecte schaduwdoek? Bekijk hier de keuzehulp pagina.</a></h2>
                                </div>
        ...
        <?php
            $catMetaArray = get_option('taxonomy_' . $term->term_id);
            $productCatBottomTitle = $catMetaArray['bottom_title'];
            $productCatBottomDesc = $catMetaArray['bottom_desc'];
            $productCatBottomDesc = get_term_meta( $term->term_id, 'pro_cat_bottom_desc', true );
            if(!empty($productCatBottomTitle) || !empty($productCatBottomDesc)) :
        ?>
        <div class="category_footer">
            ...
            <div class="row">
                <div class="large-8 large-centered columns cat1-title">
                    ...
                    <?php if(!empty($productCatBottomTitle)) : ?>

                        <h2 class="page-footer-title"><?php echo $productCatBottomTitle; ?></h2>

                    <?php endif; ?>
                    <?php if(!empty($productCatBottomDesc)) : ?>

                        <div class="page-footer-des">
                            <?php echo apply_filters( 'the_content', wp_kses_post( $productCatBottomDesc ) ); ?>
                        </div>
