...
<?php
if ( has_term( 'Maatwerk Schaduwdoeken (Custom Sunsails)', 'product_cat' ) ) {

echo '<style>.recently_viewed_in_single,.woocommerce-tabs,.product_meta {
  display: none;
}</style>';
?>
<script>
document.body.innerHTML = document.body.innerHTML.replace('Add to cart', 'Klaar om mijn doek verder te ontwerpen!');
</script>
<?php
