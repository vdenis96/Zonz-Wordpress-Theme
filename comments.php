        ...
        <?php endif; ?>
            ...
            <div id="comments" class="comments-area">
                ...
                $getbowtied_comment_args = array(		
                    ...
                    'title_reply' => __( 'Laat een reactie achter', 'mr_tailor' ),
                
                    'fields' => apply_filters( 'comment_form_default_fields', array(
                    
                        'author' 	=> 	'<div class="row"><div class="large-6 columns"><p class="comment-form-author">' . '<label for="author">' . __( 'Naam', 'mr_tailor' ) . ( $req ? ' <span class="required">*</span>' : '' ) . '</label> ' .
                                        '<input id="author" name="author" type="text" value="' . esc_attr( $commenter['comment_author'] ) . '" size="30"' . $aria_req . ' /></p></div>',
                        'email'  	=> 	'<div class="large-6 columns"><p class="comment-form-email"><label for="email">' . __( 'E-mailadres', 'mr_tailor' ) . ( $req ? ' <span class="required">*</span>' : '' ) . '</label> ' .
                    ...
                    'comment_field' =>	'<div class="row"><div class="large-12 columns"><p>' .	
                                        '<label for="comment">' . __( 'Bericht', 'mr_tailor' ) . ( $req ? ' <span class="required">*</span>' : '' ) . '</label>' .
